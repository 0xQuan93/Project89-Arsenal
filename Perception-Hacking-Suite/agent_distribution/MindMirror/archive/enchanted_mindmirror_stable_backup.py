...
class ThemeManager:
    ...
    def __init__(self):
        ...
        self.DARK_THEME = {
            ...
            'success_glow': '#00FFB233',  # Success glow
            'warning': '#FFCC00',  # Cosmic gold - brighter
            'warning_glow': '#FFCC0033',  # Warning glow
            'error': '#FF3A6A',  # Reality glitch
            'error_glow': '#FF3A6A33',  # Error glow
            'info': '#00D2FF',  # Quantum stream - brighter
            'info_glow': '#00D2FF33',  # Info glow
            ...
            'quantum_effect': '#7C3AFF',  # Subtle quantum effect
        ...
        self.LIGHT_THEME = {
            ...
            'success_glow': '#00CC8F33',  # Success glow
            'warning': '#FFA800',  # Solar energy
            'warning_glow': '#FFA80033',  # Warning glow
            'error': '#FF2B55',  # Reality break
            'error_glow': '#FF2B5533',  # Error glow
            'info': '#00A6E0',  # Info stream
            'info_glow': '#00A6E033',  # Info glow
            ...
            'glow': '#7C3AFF44',  # Quantum glow effect
            'quantum_effect': '#7C3AFF33',  # Subtle quantum effect
            'star_color': '#7C3AFF',  # Star color for light theme
            'nebula_1': '#9D4EDD44',  # Nebula effect 1
            'nebula_2': '#C77DFF44',  # Nebula effect 2
            'nebula_3': '#7B2CBF44',  # Nebula effect 3
            'grid_line': '#A0B8E033',  # Grid lines
            'node_color': '#00A6E0',  # Node color
            'neural_connection': '#7C3AFF44',  # Neural connection color
            # For backward compatibility with existing code
            'background': '#F0F5FF',
            'foreground': '#0D1221',
            'secondary': '#E6EFFF'
    ...
    def create_neural_network(self, canvas):
        ...
        try:
            ...
            for i, node in enumerate(nodes):
                ...
                connections = random.randint(2, min(4, num_nodes-1))
                ...
                for _ in range(connections):
                    ...
                    while True:
                        ...
                        if j != i and j not in connected_indices:
                            ...
                            # Store the line id in the node's connections
                            node['connections'].append((j, line_id))
                            break
            ...
            for node in nodes:
                canvas.create_oval(
                    ...
                    node['x'] + node['size'],
                    node['y'] + node['size'],
                    fill=self.theme_manager.get_color('node_color'),
                    outline="",
                    tags="neural_node"
                )
            ...
            def animate_neural_network():
                ...
                for item in canvas.find_withtag("neural_node"):
                    ...
                    if current_fill == self.theme_manager.get_color('node_color'):
                        canvas.itemconfig(item, fill=self.theme_manager.get_color('accent'))
                    else:
        ...
        try:
            ...
            stats_data = [
                ...
                },
                {
                    ...
                    "value": self.user_data.get("journal_entries", 0),
                    "icon": "📝"
                },
                {
                ...
                },
                {
                    ...
                    "value": self.user_data.get("consciousness_maps", 0),
                    "icon": "🧠"
                }
            ]
